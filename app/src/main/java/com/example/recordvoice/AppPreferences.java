...
public class AppPreferences {
    ...
    private AppPreferences(Context context) {
        preferences = context.getSharedPreferences(context.getPackageName() + "_preferences", MODE_PRIVATE); // From Android sources for getDefaultSharedPreferences
    }
    ...
    public void setToastStatus(boolean checked) {
        preferences.edit().putBoolean("ToastStatus", checked).commit();
    }

    public boolean getToastStatus() {
        Boolean state = preferences.getBoolean("ToastStatus", true);
        return state;
    }


    public void setNotificationsStatus(boolean checked) {
        preferences.edit().putBoolean("NotificationsStatus", checked).commit();
    }

    public boolean getNotificationsStatus() {
        Boolean state = preferences.getBoolean("NotificationsStatus", true);
        return state;
    }


    public void setStatus(boolean checked) {
        preferences.edit().putBoolean("silent", checked).commit();
    }

    public boolean getStatus() {
        Boolean state = preferences.getBoolean("silent", true);
        return state;
    }
}
